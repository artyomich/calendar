    ...
    <div class="card-body">
        <form action="{{ route("admin.users.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('middlename') ? 'has-error' : '' }}">
                ...
                <input type="text" id="middlename" name="middlename" class="form-control" value="{{ old('middlename', isset($user) ? $user->middlename : '') }}">
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.user.fields.middlename_helper') }}
                </p>
            </div>
